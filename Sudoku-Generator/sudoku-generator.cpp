...
// This constructor calls the menu() func to provide the menu. It also calls the setZeros() func to set all cells to the default 0 value.
...
// Displays a menu to the user when the SudokuFrame objects is instantiated (which is basically at the start of the program).
...
//  Fills all the values of the board with 0, the value representing an empty cell in this program.
...
public:int getCellValue(int row, int col){
 ...
 // Clears frame of all values, other than the question values, from the specified cell to the last cell.
...
// This class provides the programmer a very simple way to iterate through the possibilities of a specified cell. This object utilises linked lists.
class Possibilities{
...
public:Possibilities(){
 ...
 // This destructor destroys the linked list once the object has finished its lifespan. Calls the destroy() function.
...
private:void displayFrame(){
    ...
    //This function increments the count variable to keep track of the recursions done.
